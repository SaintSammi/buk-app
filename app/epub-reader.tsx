...
export default function EpubReaderScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Header — in normal flow so readerWrapper sits below it */}
      {controlsVisible && (
      ...
      {/* Reader — flex:1 so it fills the space between header and footer */}
      <View
      ...
      {/* Footer — in normal flow so readerWrapper sits above it */}
      {controlsVisible && (
